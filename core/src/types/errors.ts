...
export const ErrorCodes = {
  ...
  CONTRACT_TYPE_OP_FAILED: 'CONTRACT_TYPE_OP_FAILED',
  CONTRACT_BYTECODE_NOT_GRANTED: 'CONTRACT_BYTECODE_NOT_GRANTED',
  CONTRACT_TYPE_DRIFT: 'CONTRACT_TYPE_DRIFT',
  CONTRACT_TYPE_REQUIREMENTS: 'CONTRACT_TYPE_REQUIREMENTS',
  CONTRACT_TYPE_UNSUPPORTED: 'CONTRACT_TYPE_UNSUPPORTED',
  UNVERIFIED_PROVENANCE_CONFIRMATION_REQUIRED: 'UNVERIFIED_PROVENANCE_CONFIRMATION_REQUIRED',
  UNINITIALIZED_PROXY_ACK_REQUIRED: 'UNINITIALIZED_PROXY_ACK_REQUIRED',
  CONTRACT_TYPE_PROVENANCE_ACK_REQUIRED: 'CONTRACT_TYPE_PROVENANCE_ACK_REQUIRED',
  ...
  VERSION_ORIGIN_UNAPPROVED: 'VERSION_ORIGIN_UNAPPROVED',
  DIRTY_WORKTREE: 'DIRTY_WORKTREE',
  PINNED_INTEGRITY_VIOLATION: 'PINNED_INTEGRITY_VIOLATION',
  VERSION_MATERIALIZATION_TIMEOUT: 'VERSION_MATERIALIZATION_TIMEOUT',
  VERSION_WORKSPACE_PIN_REQUIRED: 'VERSION_WORKSPACE_PIN_REQUIRED',
  ...
  DEPLOYMENT_STORAGE_TRACE_BUSY: 'DEPLOYMENT_STORAGE_TRACE_BUSY',
